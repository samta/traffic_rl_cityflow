...
def parse_arguments():
    ...
    parser.add_argument("--scenario", type=str, default="2way_intersection")
...
def parse_roadnet(roadnetFile):
    ...
    for intersection in roadnet["intersections"]:
        ...
        #assert len(intersection['trafficLight']['lightphases']) == 9, "Check out light phases!"
        for phase_i in range(1, len(intersection["trafficLight"]["lightphases"])):
            ...
            for ri in p["availableRoadLinks"]:
                ...
                assert len(roadLink_lane_pair[ri]) == 2, "Check out lane numbers!"
